...
const Register = () => {
  ...
  return (
    <div className="min-h-screen py-12 flex bg-[#0E0F14] items-center justify-center">
      <ToastContainer position="top-center" />
      <div className=" p-10 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form onSubmit={handleRegistration} className="space-y-6">
          ...
          <div className="flex justify-center">
            <input type="file" onChange={handleAvatar} className="text-white" />
          </div>
