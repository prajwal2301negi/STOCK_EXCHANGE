        ...
        <div className="container bg-[#0E0F14] p-8 font-roboto space-y-12">
            <div className="bg-gray-800 p-6 rounded-xl text-white">
                {user ? (
                 ...
                 <button onClick={deleteCustomer} className="flex mt-4 bg-red-500 hover:bg-red-700 text-white justify-center py-2 px-4 rounded-xl shadow-lg ">
